...
$(window).bind('scroll', function(){
	...
	if($(window).scrollTop() > 80){
				$('#nav').addClass('fixed');
				$('#fix-cart').addClass('fixed-c');
				$('.fix-show-cart').removeClass('none');
				$('.fix-show-cart').addClass('block');
		}
		else
		{
		$('#nav').removeClass('fixed');
		$('#fix-cart').removeClass('fixed-c'); 
		$('.fix-show-cart').removeClass('block');
		$('.fix-show-cart').addClass('none');
	
}

if($(window).scrollTop() > 150){
$('#menu-filter').addClass('fixed-filters');
} else{
 $('#menu-filter').removeClass('fixed-filters');
}
if($(window).scrollTop() > 150){
$('.wrap-fixed-search-logo').addClass('fixed-filter');
} else{
 $('.wrap-fixed-search-logo').removeClass('fixed-filter');
}
